...
output_dir = "data/wind"  # in msl.py oder ptype.py anpassen
...
for step in steps:
    filename = f"wind_step_{step:03d}.grib2"  # im jeweiligen Script anpassen
    ...
    try:
        client.retrieve(
            ...
            type="fc",
            step=step,
            param="10fg",   # im jeweiligen Script anpassen
            target=target_path
        )
