...
output_dir = "data/ww"  # in msl.py oder ptype.py anpassen
...
for step in steps:
    filename = f"ptype_step_{step:03d}.grib2"  # im jeweiligen Script anpassen
    ...
    try:
        client.retrieve(
            ...
            type="fc",
            step=step,
            param="ptype",   # im jeweiligen Script anpassen
            target=target_path
        )
